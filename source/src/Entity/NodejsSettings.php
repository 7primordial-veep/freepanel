...
class NodejsSettings
{
     ...
     * @Assert\NotBlank()
     * @Assert\AtLeastOneOf({@Assert\Range(min=12,max=22)})
     */
    ...
    {
        $metadata->addConstraint(new UniqueEntity(array('fields' => ['port'], 'errorPath' => 'port', 'message' => 'This value already exists.')));
    }
}