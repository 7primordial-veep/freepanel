...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private static array $roleNames = [self::ROLE_USER => 'User', self::ROLE_ADMIN => 'Admin', self::ROLE_SITE_MANAGER => 'Site Manager'];
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    {
        $metadata->addConstraint(new UniqueEntity(array('fields' => ['userName'], 'errorPath' => 'userName', 'message' => 'This value already exists.')));
        $metadata->addConstraint(new UniqueEntity(array('fields' => ['email'], 'errorPath' => 'email', 'message' => 'This value already exists.')));
    }
}