...
class FirewallRule
{
    ...
    const TYPES = ['22' => 'SSH/SFTP', '20-21' => 'FTP', '49152-65534' => 'ProFTPD Passive Ports', '9200' => 'Elasticsearch', '3306' => 'MYSQL', '80' => 'HTTP', '443' => 'HTTPS', '8443' => 'CloudPanel', 'custom' => 'Custom'];
    ...
    {
        $metadata->addConstraint(new UniqueEntity(array('fields' => ['portRange', 'source'], 'errorPath' => 'source', 'message' => 'This value already exists.')));
    }
}