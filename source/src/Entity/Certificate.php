...
class Certificate
{
     ...
     */
    private $lastRenewAttemptAt;
    /**
     * @ORM\Column(type="text", nullable=true)
     */
    private $lastRenewError;
    ...
    public function getLastRenewAttemptAt() : ?\DateTime
    {
        return $this->lastRenewAttemptAt;
    }
    public function setLastRenewAttemptAt(?\DateTimeInterface $lastRenewAttemptAt) : void
    {
        $this->lastRenewAttemptAt = $lastRenewAttemptAt;
    }
    public function getLastRenewError() : ?string
    {
        return $this->lastRenewError;
    }
    public function setLastRenewError(?string $lastRenewError) : void
    {
        $this->lastRenewError = $lastRenewError;
    }
