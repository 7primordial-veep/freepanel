...
class BsdTarExtractCommand extends Command
{
    ...
    public function getCommand() : string
    {
        if (!$this->command) {
            ...
            $this->command = sprintf("/usr/bin/sudo /usr/bin/bsdtar --gunzip -xf %s -C %s", escapeshellarg($sourceFile), escapeshellarg($destinationFile));
        }
        return $this->command;
    }
