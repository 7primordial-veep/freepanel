...
abstract class Site
{
    ...
    protected ?Collection $blockedBots = null;
    protected ?Collection $blockedIps = null;
    protected ?Collection $databases = null;
    protected ?Certificate $certificate = null;
    protected ?Collection $certificates = null;
    protected ?Collection $cronJobs = null;
    protected ?Collection $ftpUsers = null;
    protected ?Collection $sshUsers = null;
    protected ?bool $pageSpeedEnabled = false;
    protected ?string $pageSpeedSettings = null;
    protected ?bool $allowTrafficFromCloudflareOnly = false;
    protected ?string $sshKeys = null;
    protected ?string $vhostTemplate = null;
    ...
    public function setBlockedBots(Collection $blockedBots) : void
    {
    ...
    public function setBlockedIps(Collection $blockedIps) : void
    {
    ...
    public function setDatabases(Collection $databases) : void
    {
    ...
    public function setCronJobs(Collection $cronJobs) : void
    {
    ...
    public function setFtpUsers(Collection $ftpUsers) : void
    {
    ...
    public function setSshUsers(Collection $sshUsers) : void
    {
    ...
    public function getSecurityHeadersConfig() : array
    {
        ...
        $data = json_decode($this->securityHeaders, true);
        return is_array($data) ? $data : [];
    }
    public function setSecurityHeadersConfig(array $config) : void
    {
        $this->securityHeaders = json_encode($config);
    }
    public function getSecurityHeaders() : ?string
    {
        return $this->securityHeaders;
    }
    public function setSecurityHeaders(?string $value) : void
    {
        $this->securityHeaders = $value;
    }
    protected ?string $securityHeaders = null;
}