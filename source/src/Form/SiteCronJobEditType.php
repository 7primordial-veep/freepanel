...
class SiteCronJobEditType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options) : void
    {
        ...
        $builder->add("template", ChoiceType::class, ["required" => false, "mapped" => false, "attr" => ["class" => "form-select form-select-lg"], "label" => "Template", "choices" => $templateChoices]);
        ...
        $builder->add("command", TextType::class, ["required" => true, "attr" => ["class" => "form-control form-control-lg"], "label" => "Command", "constraints" => [new Assert\Regex("/^(?!.*\\b(admin |clp|root|ubuntu|www-data)\\b)(?!.*\\n).*\$/")]]);
