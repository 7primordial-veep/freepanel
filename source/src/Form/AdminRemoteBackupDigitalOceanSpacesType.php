...
class AdminRemoteBackupDigitalOceanSpacesType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options) : void
    {
        ...
        $builder->add("secretAccessKey", TextType::class, ["required" => true, "attr" => ["class" => "form-control form-control-lg", "placeholder" => "lubkWMvb5f46GWoniX7oYbh1wq7XP+LUObym+HG1"], "label" => "Secret Access Key"]);
