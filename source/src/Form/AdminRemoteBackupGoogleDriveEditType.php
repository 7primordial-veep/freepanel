...
class AdminRemoteBackupGoogleDriveEditType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options) : void
    {
        ...
        $builder->add("serviceAccount", TextareaType::class, ["required" => false, "attr" => ["class" => "form-control form-control-lg", "rows" => 6], "label" => "Service Account", "constraints" => [new AppAssert\GoogleDriveCredentials()]]);
