...
class AdminAwsImagesSettingsType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options) : void
    {
        $builder->add("automaticImages", CheckboxType::class, ["required" => false, "attr" => ["class" => "form-check-input"], "label" => "Enable Automatic Images"]);
        $frequencyChoices = ["Every Hour" => 1, "Every Three Hours" => 3, "Every Six Hours" => 6, "Every Twelve Hours" => 12, "Once per Day" => 24];
    ...
    {
        return "clp_admin_aws_images_settings";
    }
}