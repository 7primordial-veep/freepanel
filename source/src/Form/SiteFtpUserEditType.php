...
class SiteFtpUserEditType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options) : void
    {
        ...
        $builder->add("homeDirectory", TextType::class, ["required" => true, "mapped" => true, "attr" => ["class" => "form-control form-control-lg"], "label" => "Home Directory"]);
