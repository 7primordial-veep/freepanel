...
class AdminRemoteBackupCustomRcloneType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options) : void
    {
        ...
        $builder->add("storageDirectory", TextType::class, ["required" => true, "attr" => ["class" => "form-control form-control-lg"], "label" => "Storage Directory", "data" => "backups", "constraints" => [new AppAssert\CustomRcloneConfig()]]);
    ...
    {
        return "clp_admin_remote_backup_custom_rclone";
    }
}