...
class AdminRemoteBackupSftpEditType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options) : void
    {
        ...
        $builder->add("authenticationMethod", ChoiceType::class, ["required" => true, "attr" => ["class" => "form-select form-select-lg"], "label" => "Authentication Method", "choices" => $authenticationMethodChoices]);
        ...
        $builder->add("storageDirectory", TextType::class, ["required" => true, "attr" => ["class" => "form-control form-control-lg", "placeholder" => "/home/backup-master/"], "label" => "Remote Server Path"]);
        $builder->add("port", TextType::class, ["required" => true, "attr" => ["class" => "form-control form-control-lg", "placeholder" => "22"], "label" => "Port"]);
