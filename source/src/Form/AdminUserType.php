...
class AdminUserType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) : void
    {
        ...
        $builder->add("plainPassword", TextType::class, ["required" => true, "attr" => ["class" => "form-control form-control-lg"], "label" => "Password", "empty_data" => null, "constraints" => [new Assert\Length(["min" => UserEntity::PASSWORD_MIN_LENGTH, "max" => UserEntity::PASSWORD_MAX_LENGTH])]]);
        ...
        $builder->add("sites", TextType::class, ["label" => "Sites", "attr" => ["class" => "d-none"], "mapped" => false, "required" => false, "constraints" => [new UserSitesConstraint()]]);
