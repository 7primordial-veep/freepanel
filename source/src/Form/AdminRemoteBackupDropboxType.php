...
class AdminRemoteBackupDropboxType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options) : void
    {
        $request = $options["data"]["request"];
        ...
        $dropboxAccessCodeConstraint = new AppAssert\DropboxAccessCode();
        $dropboxAccessCodeConstraint->setRequest($request);
        $builder->add("accessCode", TextType::class, ["required" => true, "attr" => ["class" => "form-control form-control-lg", "placeholder" => "RgmMiPMbPfUAAAAAAAAADhi_ix1WgSuL5f_4_FH-jr"], "label" => "Access Code", "constraints" => [$dropboxAccessCodeConstraint]]);
    ...
    {
        return "clp_admin_remote_backup_dropbox";
    }
}